# Sovereign Prompt Execution Pack - ERP-Autonomous-Coding

These prompts operationalize the Sovereign SaaS 2026 guidance for **ERP-Autonomous-Coding** (Autonomous Software Delivery).

## Prompt 1 - Domain and Tenant Contract

```
You are implementing hard multi-tenancy for ERP-Autonomous-Coding.
...
```
You are implementing event-native workflows for ERP-Autonomous-Coding.

Tasks:
1. Define event contracts for: coding.plans, coding.runs, coding.reviews.
...
```
You are redesigning ERP-Autonomous-Coding for category leadership against GitHub Copilot Workspace, Sourcegraph Cody, Cursor.
...
```
You are preparing ERP-Autonomous-Coding for immediate production deployment.

Tasks:
1. Enforce SLO checks (availability 99.9%, p95 <= 300ms).
