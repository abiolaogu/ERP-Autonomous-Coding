...
func TestCursorRoundTrip(t *testing.T) {
	...
	for i := 0; i < 5; i++ {
		createEntity(t, mux, tenant, map[string]any{"user_id": "u1", "title": "Plan " + string(rune('A'+i))})
	}
...
func TestMemoryListInvalidatesCache(t *testing.T) {
	...
	createEntity(t, mux, tenant, map[string]any{"user_id": "u1", "title": "Cache Test"})
	...
	createEntity(t, mux, tenant, map[string]any{"user_id": "u1", "title": "Cache Test 2"})
...
func TestUpdateAndDelete(t *testing.T) {
	_, mux := setupTestServer()
	resp := createEntity(t, mux, "t1", map[string]any{"user_id": "u1", "title": "Del Test"})
